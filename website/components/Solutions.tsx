...
const EXAMPLES = [
  ...
  },
  {
    ...
    image: "/images/solutions/solution-2-site-formulaire-v3.jpg" as string | undefined,
        ...
        >
          {EXAMPLES.map((example, index) => {
            ...
            return (
              ...
              >
                <div className="relative aspect-[3/1] w-full shrink-0 overflow-hidden bg-gradient-to-br from-primary/10 to-primary-dark/5">
                  {example.image ? (
                    <Image
                      src={example.image}
                      alt={example.title}
