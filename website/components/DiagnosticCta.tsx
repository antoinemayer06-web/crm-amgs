    ...
    >
      ...
      >
        <Link
          ...
          className="flex w-full items-center justify-center gap-2.5 rounded-full bg-ink px-6 py-3 text-sm font-semibold text-white transition-colors hover:bg-primary-dark"
        >
