  ...
  return (
    <>
      ...
      <PillarPage
        ...
        questionAnswer={[
          "La plupart des PME réunionnaises que nous accompagnons utilisent déjà au moins deux outils pour gérer leurs projets : un CRM (Axonaut, HubSpot...) pour le commercial, et un outil de gestion de tâches (ClickUp, Monday, Trello...) pour le suivi opérationnel. Le problème n'est pas le nombre d'outils, c'est qu'ils ne se parlent pas entre eux. Chaque nouveau client signé dans le CRM doit être recréé manuellement dans l'outil de gestion — dossier, tâches, échéances, affectation à l'équipe.",
